...
<div class="heading">
 ...
 <section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa_times" onclick="return confirm ('Vous vouler suprimer ce produit de votre panier ?');"></a>
         ...
         <form action="" method="post">
            ...
            <input type="submit" name="update_cart" value="Update" class="option_btn" style="cursor: pointer; font-size: 20px;">
         </form>
...
<div class="cart-total">
   ...
   <div class="flex">
      ...
      <a href="checkout.php" class="btn">passer au payment</a>
   </div>
</div>
 </section>
