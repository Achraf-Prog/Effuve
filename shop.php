    ...
    header('location:login.php');
     ...
     if(isset($_POST['add_to_cart'])){
      ...
      if(mysqli_num_rows($check_cart_numbers) > 0){
         ...
         mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, image) VALUES('$user_id', '$product_name', '$product_price', '$product_image')") or die ('erreur');
...
<div class="heading">
   <h3>Nos produit</h3>
   <p><a href="home.php">Accueil</a> / shop</p>
 </div>


</section>
   <section class="products">
      <h1 class="title">Notre collection</h1>
